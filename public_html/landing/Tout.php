...
<html style="font-size: 16px;">
  ...
  <link rel="icon" type="image/png" href="icone.png">
    ...
    <title>Lymation - Tout</title>
    <link rel="stylesheet" href="nicepage.css" media="screen">
<link rel="stylesheet" href="Tout.css" media="screen">
...
<script>
  ...
  <body class="u-body u-xl-mode"><header class="u-align-center u-clearfix u-header u-palette-1-base u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xl u-header" id="sec-dad3" data-animation-name="" data-animation-duration="0" data-animation-delay="0" data-animation-direction=""><h2 class="u-custom-font u-enable-responsive u-font-roboto u-text u-text-1">Lymation</h2><span class="u-enable-responsive u-file-icon u-icon u-text-white u-icon-1"><img src="images/1.png" alt=""></span><nav class="u-menu u-menu-one-level u-menu-open-right u-offcanvas u-menu-1" data-responsive-from="XS">
    ...
    <section class="u-clearfix u-white u-section-1" id="sec-e5fe">
        ...
        <div class="u-repeater u-repeater-1">
          <div class="u-align-center u-container-style u-custom-item u-list-item u-palette-1-dark-2 u-repeater-item">
            <div class="u-container-layout u-similar-container u-container-layout-1">
              <a href="Tout.php" data-page-id="19442632" class="u-active-palette-1-dark-1 u-border-none u-btn u-button-style u-custom-item u-hover-palette-1-dark-1 u-palette-1-dark-1 u-btn-1">Tout</a>
            </div>
          </div>
          <div class="u-align-center u-container-style u-custom-item u-list-item u-palette-1-dark-2 u-repeater-item">
          ...
          <div class="u-align-center u-container-style u-custom-item u-list-item u-palette-1-dark-2 u-repeater-item">
            <div class="u-container-layout u-similar-container u-container-layout-3">
              <a href="Pertes.php" data-page-id="2767023816" class="u-border-none u-btn u-button-style u-custom-item u-hover-palette-1-dark-1 u-palette-1-dark-2 u-btn-3">Pertes</a>
            </div>
          </div>
          <div class="u-align-center u-container-style u-custom-item u-list-item u-palette-1-dark-2 u-repeater-item">
          ...
          <div class="u-align-center u-container-style u-custom-item u-list-item u-palette-1-dark-2 u-repeater-item">
            <div class="u-container-layout u-similar-container u-container-layout-5">
              <a href="Autres.php" data-page-id="19442632" class="u-border-none u-btn u-button-style u-custom-item u-hover-palette-1-dark-1 u-palette-1-dark-2 u-btn-5">Autres</a>
            </div>
          </div>
        </div>
      </div>
      <?php while($c = $article->fetch()) {
        ...
        <div class="u-container-layout u-container-layout-6">
          <h6 class="u-text u-text-palette-1-dark-2 u-text-1" style="font-weight : bolder;">
          <?php if($c['token'] == $_SESSION['user'] || $_SESSION['user'] == '9ed090f6a3a62c7986f6d19c24b4fa9d1be15fa796eb0345678c8a49bf2bd09201a15e0ecc6da70b6c55b4d272e423c379b2b91d5e0d77887d58ce0f6928a49e') { ?>
          <a <?php echo "href=delet.php?id=".$c['id']."&page=Tout"; ?> style="background-image: none; margin: 25px auto 0 0; padding: 0;" ><span style="font-size: 1em;" class="u-file-icon u-icon u-text-custom-color-1 u-icon-1"><img src="images/2.png" alt=""></span></a>
          <?php } ?>
            <?php
          ...
          <div class="u-clearfix u-group-elements u-group-elements-1">
            <a <?php echo "href=like_traitement/pourquoi.php?page=Tout&id=".$c['id'];?> class="u-border-none u-btn u-button-style u-custom-color-2 u-btn-6">Pourquoi ?<br>
            </a>
          ...
          <div class="u-clearfix u-group-elements u-group-elements-2">
            <a <?php echo "href=like_traitement/bonne_chance.php?page=Tout&id=".$c['id'];?> class="u-border-none u-btn u-button-style u-custom-color-5 u-btn-7">Bonne chance<br>
            </a>
          ...
          <div class="u-clearfix u-group-elements u-group-elements-3">
            <a <?php echo "href=like_traitement/chaud.php?page=Tout&id=".$c['id'];?> class="u-btn u-button-style u-custom-color-3 u-btn-8">chaud !</a>
          ...
          <div class="u-clearfix u-group-elements u-group-elements-4">
            <a <?php echo "href=like_traitement/tu_veux_la_prison.php?page=Tout&id=".$c['id'];?> class="u-border-none u-btn u-button-style u-custom-color-4 u-btn-9">Tu veux la prison ?</a>
          ...
          <a <?php echo "href=commentary/Commentaires.php?page=Tout&id=".$c['id']; ?> class="u-border-none u-btn u-btn-round u-button-style u-hover-palette-1-dark-1 u-palette-1-dark-2 u-radius-30 u-btn-10">commentaires</a>
        </div>
        </div>
  <?php }} ?>
    </section>
