...
<html style="font-size: 16px;">
  ...
  <link rel="icon" type="image/png" href="icone.png">
    ...
    <title>Lymation - Autres</title>
    <link rel="stylesheet" href="nicepage.css" media="screen">
<link rel="stylesheet" href="Autres.css" media="screen">
        ...
        <div class="u-custom-menu u-nav-container-collapse">
          <div class="u-black u-container-style u-inner-container-layout u-opacity u-opacity-95 u-sidenav">
            <div class="u-inner-container-layout u-sidenav-overflow">
              ...
              <ul class="u-align-center u-nav u-popupmenu-items u-unstyled u-nav-2"><li class="u-nav-item"><a class="u-button-style u-nav-link" href="publication/Publier.html">Publier</a>
        ...
        <div class="u-repeater u-repeater-1">
          ...
          <div class="u-align-center u-container-style u-custom-item u-list-item u-palette-1-dark-2 u-repeater-item">
            <div class="u-container-layout u-similar-container u-container-layout-5">
              <a href="Autres.php" data-page-id="776423228" class="u-border-none u-btn u-button-style u-custom-item u-hover-palette-1-dark-1 u-palette-1-dark-1 u-btn-5">Autres</a>
            </div>
          </div>
        </div>
      </div>
      <?php while($c = $article->fetch()) { 
        if($c['cathegorie'] == 'autres' && $c['anonyme'] != 'delet'){ ?>
        ...
        <div class="u-container-layout u-container-layout-6">
          ...
          <a <?php echo "href=delet.php?id=".$c['id']."&page=Autres"; ?> style="background-image: none; margin: 25px auto 0 0; padding: 0;" ><span style="font-size: 1em;" class="u-file-icon u-icon u-text-custom-color-1 u-icon-1"><img src="images/2.png" alt=""></span></a>
          <?php } ?>
            <?php
          ...
          <div class="u-clearfix u-group-elements u-group-elements-1">
            <a <?php echo "href=like_traitement/pourquoi.php?page=Autres&id=".$c['id'];?> class="u-border-none u-btn u-button-style u-custom-color-2 u-btn-6">Pourquoi ?<br>
            </a>
          ...
          <div class="u-clearfix u-group-elements u-group-elements-2">
            <a <?php echo "href=like_traitement/bonne_chance.php?page=Autres&id=".$c['id'];?> class="u-border-none u-btn u-button-style u-custom-color-5 u-btn-7">Bonne chance<br>
            </a>
          ...
          <div class="u-clearfix u-group-elements u-group-elements-3">
            <a <?php echo "href=like_traitement/chaud.php?page=Autres&id=".$c['id'];?> class="u-btn u-button-style u-custom-color-3 u-btn-8">chaud !</a>
          ...
          <div class="u-clearfix u-group-elements u-group-elements-4">
            <a <?php echo "href=like_traitement/tu_veux_la_prison.php?page=Autres&id=".$c['id'];?> class="u-border-none u-btn u-button-style u-custom-color-4 u-btn-9">Tu veux la prison ?</a>
          ...
          <a <?php echo "href=commentary/Commentaires.php?page=Autres&id=".$c['id']; ?> class="u-border-none u-btn u-btn-round u-button-style u-hover-palette-1-dark-1 u-palette-1-dark-2 u-radius-30 u-btn-10">commentaires</a>
        </div>
      </div>
      <?php }} ?>
    </section>
